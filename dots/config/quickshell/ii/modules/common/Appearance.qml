...
Singleton {
    ...
    animationCurves: QtObject {
        readonly property list<real> expressiveDefaultSpatial: [0.05, 0.90, 0.10, 1.05, 1, 1]
        readonly property list<real> expressiveFastSpatial:    [0.10, 1.00, 0.30, 1.00, 1, 1]
        readonly property list<real> expressiveSlowSpatial:    [0.05, 0.85, 0.15, 1.00, 1, 1]
        readonly property list<real> expressiveEffects:        [0.10, 0.90, 0.10, 1.00, 1, 1]

        // 关键：缩短时长，提升响应感
        readonly property real expressiveDefaultSpatialDuration: 400  // 从 500ms 降至 400ms
        readonly property real expressiveFastSpatialDuration:    250  // 极速反馈
        readonly property real expressiveSlowSpatialDuration:    550  // 柔和反馈
        readonly property real expressiveEffectsDuration:        200  // 小部件动画

        // 其他辅助曲线保持相对兼容
        readonly property list<real> emphasized: [0.05, 0, 0.13, 0.06, 0.16, 0.4, 0.21, 0.82, 0.25, 1, 1, 1]
        readonly property list<real> emphasizedFirstHalf: [0.05, 0, 0.13, 0.06, 0.16, 0.4, 0.21, 0.82]
        readonly property list<real> emphasizedLastHalf: [0.21, 0.82, 0.25, 1, 1, 1]
    ...
    animation: QtObject {
        ...
        property QtObject elementMoveExit: QtObject {
            property int duration: 250 // 加快退出速度
            property int type: Easing.BezierSpline
        ...
        property QtObject clickBounce: QtObject {
            property int duration: 300 // 点击反馈要快
            property int type: Easing.BezierSpline
        ...
        property QtObject menuDecel: QtObject {
            ...
            property int type: Easing.OutQuart // 相比 OutExpo 更平滑
        }
    }
